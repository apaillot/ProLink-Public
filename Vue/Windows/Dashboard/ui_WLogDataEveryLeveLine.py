...
################################################################################
## Form generated from reading UI file 'WLogDataEveryLeveLine.ui'
##
...
"}")
        ...
        self.spinBox_Hours.setMaximum(120)

        self.gridLayout.addWidget(self.spinBox_Hours, 1, 1, 1, 1)

        self.spinBox_Secs = QDoubleSpinBox(self.widget)
        self.spinBox_Secs.setObjectName(u"spinBox_Secs")
        self.spinBox_Secs.setMinimumSize(QSize(0, 28))
        self.spinBox_Secs.setDecimals(1)
        self.spinBox_Secs.setMaximum(59.899999999999999)
