...
from Vue.Windows.Dashboard.ui_WOpticalAvg import Ui_WOpticalAvg
...
# Fenêtre modification configuration
#----------------------------------------------------------------------------#
class UIOpticalAvg(QWidget, Ui_WOpticalAvg):
 # -- Signal list --
 siOpen      = Signal()
 ...
 def vFOpen( self, uiValue ):
  ...
  self.spinBox_OpticalAvg.setValue(uiValue)
 ...
 def accept(self):
  ...
  uiValue = self.spinBox_OpticalAvg.value()
