...
from Vue.Windows.Dashboard.ui_WSetupLoggingThreshold import Ui_WSetupLoggingThreshold
...
# Fenêtre modification configuration
#----------------------------------------------------------------------------#
class UISetupLoggingThreshold(QWidget, Ui_WSetupLoggingThreshold):
 # -- Signal list --
 siOpen      = Signal()
 ...
 def vFOpen( self, uiValue ):
  ...
  self.spinBox_SetupLoggingThreshold.setValue(uiValue)
 ...
 def accept(self):
  ...
  uiValue = self.spinBox_SetupLoggingThreshold.value()
