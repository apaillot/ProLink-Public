...
from Vue.Windows.Dashboard.ui_WSiteAltitude import Ui_WSiteAltitude
...
# Fenêtre modification configuration
#----------------------------------------------------------------------------#
class UISiteAltitude(QWidget, Ui_WSiteAltitude):
 # -- Signal list --
 siOpen      = Signal()
 ...
 def vFOpen( self, uiValue ):
  ...
  self.spinBox_Altitude.setValue(uiValue)
 ...
 def accept(self):
  ...
  uiValue = self.spinBox_Altitude.value()
