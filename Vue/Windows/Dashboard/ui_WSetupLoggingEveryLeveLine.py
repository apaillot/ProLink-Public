...
################################################################################
## Form generated from reading UI file 'WSetupLoggingEveryLeveLine.ui'
##
...
"}")
        ...
        self.spinBox_SetupLoggingEverySecs = QDoubleSpinBox(self.widget)
        self.spinBox_SetupLoggingEverySecs.setObjectName(u"spinBox_SetupLoggingEverySecs")
        self.spinBox_SetupLoggingEverySecs.setMinimumSize(QSize(0, 28))
        self.spinBox_SetupLoggingEverySecs.setDecimals(1)
        self.spinBox_SetupLoggingEverySecs.setMaximum(59.899999999999999)

        self.gridLayout.addWidget(self.spinBox_SetupLoggingEverySecs, 1, 3, 1, 1)
    ...
    def retranslateUi(self, WSetupLoggingEvery):
        ...
        self.label_4.setText(QCoreApplication.translate("WSetupLoggingEvery", u"Secs", None))
