...
from Vue.Windows.Dashboard.ui_WSetupLoggingCheck import Ui_WSetupLoggingCheck
...
# Fenêtre modification configuration
#----------------------------------------------------------------------------#
class UISetupLoggingCheck(QWidget, Ui_WSetupLoggingCheck):
 # -- Signal list --
 siOpen      = Signal()
 ...
 def vFOpen( self, sTxt ):
  ...
  self.comboBox_SetupLoggingCheck.setCurrentText(sTxt)
