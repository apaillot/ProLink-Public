...
from Vue.Windows.Dashboard.ui_WSetupLoggingState import Ui_WSetupLoggingState
...
# Fenêtre modification configuration
#----------------------------------------------------------------------------#
class UISetupLoggingState(QWidget, Ui_WSetupLoggingState):
 # -- Signal list --
 siOpen      = Signal()
 ...
 def vFOpen( self, sTxt ):
  ...
  self.comboBox_SetupLoggingState.setCurrentText(sTxt)
 ...
 def accept(self):
  ...
  sTxt = self.comboBox_SetupLoggingState.currentText()
  print("sTxt = %s"%sTxt)
  # Signal d'écriture
